  ...
  <div class="mb-6 w-full max-w-md rounded-xl bg-white p-6 shadow-md">
    ...
    <div class="flex gap-2">
      <input
        ...
        disabled={loading}
        class="flex-1 rounded-lg border border-gray-300 px-4 py-2 shadow-sm transition focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-none"
      />
      <button
